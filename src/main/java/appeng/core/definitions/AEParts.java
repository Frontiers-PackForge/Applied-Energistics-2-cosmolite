...
public final class AEParts {
    ...
    public static final ItemDefinition<PartItem<InterfaceAccessTerminalPart>> INTERFACE_ACCESS_TERMINAL = createPart("ME Interface Access Terminal", AEPartIds.INTERFACE_ACCESS_TERMINAL, InterfaceAccessTerminalPart.class, InterfaceAccessTerminalPart::new);
