...
public enum ButtonToolTips implements LocalizationEnum {
    ...
    InterfaceAccessTerminalShow("Show this interface in the Interface Access Terminal"),
    InterfaceAccessTerminalHide("Hide this interface from the Interface Access Terminal"),
