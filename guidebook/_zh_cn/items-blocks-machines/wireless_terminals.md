...
无线终端是有线[终端](terminals.md)的便携版本。其 UI 与有线终端一致，但无线终端只有[升级卡](upgrade_cards.md)槽位，没有 <ItemLink id="view_cell" /> 槽位。

可将终端放入 <ItemLink id="wireless_access_point" /> 右上角槽位（带无线终端图标且下方有箭头）来与该访问点所在网络配对。
...
基础终端的便携版。可在 <ItemLink id="wireless_access_point" /> 覆盖范围内访问[网络存储](../ae2-mechanics/import-export-storage.md)，或向[自动合成](../ae2-mechanics/autocrafting.md)系统发送请求。
