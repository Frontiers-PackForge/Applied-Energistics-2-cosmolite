...
能源接收器会将其他科技模组的常见能量系统转换为 AE2 内部使用的[能量](../ae2-mechanics/energy.md)（AE）。虽然 <ItemLink id="controller" /> 也能做到，但控制器各个面的连接价值很高，通常更推荐使用能源接收器。

Forge Energy 与 TechReborn Energy 的转换比为：
