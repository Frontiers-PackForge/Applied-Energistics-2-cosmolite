...
硅、逻辑、计算、工程压印模板均用于[处理器](processors.md)制造流程。这 4 种压印模板可通过破坏[陨石](../ae2-mechanics/meteorites.md)中的 <ItemLink id="mysterious_cube" /> 获得，也可在 <ItemLink id="inscriber" /> 中复制。
